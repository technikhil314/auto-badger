...
exports.generate = async function () {
    const [coverageType, repoUrl] = await Promise.all([detectType(coverageProviders, "COVERAGE"), detectRepoUrl()]);
    ...
    switch (coverageType) {
        ...
        default:
            console.error("Could not find any code coverage related configuration. Skipping it...");
            return '';
    }
}